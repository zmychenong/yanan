 ...
 *         &lt;element name="Card" type="{http://schemas.datacontract.org/2004/07/AGVServer.AGVS.Service}IOCardData" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "ModifyCard")
public class ModifyCard {
    ...
    @XmlElementRef(name = "Card", namespace = "http://tempuri.org/", type = JAXBElement.class, required = false)
    protected JAXBElement<IOCardData> card;
     ...
     *     
     */
    public JAXBElement<IOCardData> getCard() {
        return card;
    }
     ...
     *     
     */
    public void setCard(JAXBElement<IOCardData> value) {
        this.card = value;
    }
