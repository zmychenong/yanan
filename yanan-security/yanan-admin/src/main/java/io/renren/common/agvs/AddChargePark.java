 ...
 *         &lt;element name="chargeParkList" type="{http://schemas.datacontract.org/2004/07/AGVServer.AGVS.Service}ChargeParkMessage" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "AddChargePark")
public class AddChargePark {
    ...
    protected JAXBElement<ChargeParkMessage> chargeParkList;
     ...
     *     
     */
    public JAXBElement<ChargeParkMessage> getChargeParkList() {
     ...
     *     
     */
    public void setChargeParkList(JAXBElement<ChargeParkMessage> value) {
